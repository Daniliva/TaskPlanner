...
import ua.opnu.compapp.ui.screens.task.all.AllTasksScreen
import ua.opnu.compapp.ui.screens.task.edit.EditTaskScreen
...
import ua.opnu.compapp.ui.screens.task.view.ViewTaskScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                ViewTaskScreen(id = entry.arguments?.getLong("id") ?: -1)
            }
            ...
            composable(
                ...
                EditTaskScreen(id = entry.arguments?.getLong("id") ?: -1, navController)
            }
        }
    }
}
